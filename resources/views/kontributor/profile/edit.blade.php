...
@section('title','Edit Profile Kontributor')   
@section('content')   
    ...
    <div class="col-md-10 container">
        <div class="card card-dark">
              <div class="card-header">
                <h3 class="card-title" ><b>Form Edit Profile Kontributor</b></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{route('profile.updatekontributor',$profil->id)}}" method="POST" enctype="multipart/form-data">
              @method('put')
              @csrf
                <div class="card-body">
                <!-- row1 -->
                ...
                <div class="card-footer">
                  ...
                  <a href="{{route('profile.kontributor')}}" class="btn btn-default float-right">Cancel</a>
                </div>
                <!-- /.card-footer -->
              </form>
        </div>
