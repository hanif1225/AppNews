...
<div class="col-md-6 container">
            <div class="card card-dark card-outline">
              <!-- card-body -->
              <h1 align="center" style="color:#212529"><b>Profile Kontributor</b></h1>
          ...
          @if($user->profil == null)
              <ul class="list-group list-group-unbordered mb-3 mt-2">
                ...
                <a href="{{route('profile.createkontributor')}}" class="btn btn-primary btn-block"><b>Lengkapi Profile</b></a>
              @else
                ...
                <a href="{{route('profile.editkontributor',$user->profil->id)}}" class="btn btn-dark btn-block"><b>Edit Profile</b></a>
              @endif
              <!-- end profile -->
              </div>
              <!-- /.card-body -->
