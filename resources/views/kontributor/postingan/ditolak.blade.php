            ...
            <div class="card">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                 <form action="/postingan/reject/kontributor">
                  ...
                  @foreach($data_postingan as $postingan)
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{route('postingan_kontributor_perbaikan',$postingan->slug)}}" class="btn btn-sm btn-primary"><i class="fas fa-tools"></i></a>
                        <form action="{{route('postingan_kontributor_delete',$postingan->slug)}}" method="post" class="d-inline">
                          @method('delete')
                          @csrf
