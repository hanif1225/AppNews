                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        @if($post->status == 'selesai')
                          ...
                          <a href="{{route('postingan_editor_alasan',$post->slug)}}" class="btn btn-sm btn-danger" ><i class="fas fa-times"></i></a>
                          @endif
                      </td>
                    </tr>
                    @endforeach
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form" action="{{route('postingan_editor_publish',$postingan->slug)}}" method="post" enctype="multipart/form-data">
        @method('put')
        @csrf
