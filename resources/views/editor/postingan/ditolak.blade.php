            ...
            <div class="card">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                 <form action="/postingan/reject/editor">
                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  @foreach($data_postingan as $postingan)
                    <tr>
                      ...
                      <td>
                        <form action="{{route('postingan_delete_editor',$postingan->slug)}}" method="post" class="d-inline">
                          @method('delete')
                          @csrf
                          <button class="btn btn-sm btn-danger" onclick="return confirm('Apakah data ingin di hapus')"><i class="fas fa-trash"></i></button>
                        </form>
                        <!-- <a href="{{route('postingan_editor_show',$postingan->slug)}}" class="btn btn-sm btn-success"><i class="fas fa-search"></i></a> -->
                      </td> 
                    </tr>
                    @endforeach
