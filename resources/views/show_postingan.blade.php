                ...
                <div class=" col-lg-9">
                    <div class="binduz-er-author-item mb-40">
                        ...
                        <div class="binduz-er-blog-details-box">
                            ...
                            <div class="binduz-er-meta-author">
                                <div class="binduz-er-author">
                                    <img src="{{asset('foto')}}/pengguna.png" class="rounded-circle" height="40" width="40" alt="">
                                    <span class="px-1"><b>{{$komentar->user->name}}</b></span>
                                      <div class="px-5"> 
                                        <p>Komentar anda sedang menunggu dimoderasi.komentar Anda akan tampil setelah disetujui.</p>
                                      </div>
                                      <div class="px-5"> 
                                        <p>Isi Komentar : {{$komentar->isi}}</p>
                                      </div>
                                </div>
                                <hr>
