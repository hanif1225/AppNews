            ...
            <div class="card">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                 <form action="/admpostingan/pending" >
                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  @foreach($data_postingan as $post)
                    <tr>
                      ...
                      <td>{{$post->status}}</td>
                      <td>
                        <!-- <a href="{{route('postingan_show_adm',$post->slug)}}" class="btn btn-sm btn-success"><i class="fas fa-search"></i> </a> -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <form class="form" action="{{route('postingan_editing_adm',$postingan->slug)}}" method="post" enctype="multipart/form-data">
        @method('put')
        @csrf
