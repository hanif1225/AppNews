                ...
                <div class=" col-lg-9">
                    <div class="binduz-er-author-item mb-40">
                        <div class="binduz-er-thumb">
                            <img src="{{asset('postingan')}}/{{$postingan->gambar}}" height="800" width="200" alt="">
                        </div>
                        <div class="binduz-er-content">
                            ...
                            <div class="binduz-er-meta-author">
                                ...
                                @if($postingan->user->profil == null)
                                    <img src="{{asset('foto')}}/user.pnf" height="40" width="40" alt="">
                                @else    
                        ...
                        <div class="binduz-er-blog-details-box">
                            ...
                            <div class="mt-4">
                            <a href="{{route('postingan_pending_adm')}}" class="btn btn-sm btn-primary"><i class="fas fa-arrow-circle-left"></i> Kembali ke halaman pending</a>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <p class="comment-notes"><span id="email-notes">Jika ingin memberi komentar silahkan login terlebih dahulu !!</span></p>
                                            <div class="binduz-er-input-box">
                                                <textarea name="#" id="#" cols="10" rows="2" placeholder="Komentar"></textarea>
                                            </div>
                                        </div>
                                        <div class=" col-lg-12">
                                            <div class="binduz-er-input-box text-end mt-2">
                                                <button type="button" class="binduz-er-main-btn">Kirim Komentar</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
