            ...
            <div class="card">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <form action="/admkomentar/pending" >
                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  @foreach($komentar as $komen)
                    <tr>
                      ...
                      <td>{{$komen->isi}}</td>
                      <td>
                        <form action="{{route('komentar_adm_aktif',$komen->id)}}" method="post" class="d-inline">
                          @method('put')
                          @csrf
                          <button class="btn btn-sm btn-primary" onclick="return confirm('Apakah Komentar ingin di Aktifkan?')"><i class="fas fa-check"></i></button>
                        </form>
                        <a href="{{route('komentar_adm_alasan',$komen->id)}}" class="btn btn-sm btn-danger" ><i class="fas fa-times"></i></a>
                      </td>
                    </tr>
                    @endforeach
