    ...
    <div class="col-md-10 container">
        <div class="card card-dark">
              <div class="card-header">
                <h3 class="card-title" ><b>Form Edit Profile Pengguna</b></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{route('datapengguna.update',$profil->id)}}" method="POST" enctype="multipart/form-data">
              @method('put')
              @csrf
                <div class="card-body">
                <!-- row1 -->
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <input type="email" name="email2" value="{{old('email',$user->email)}}" class="form-control" hidden id="email2"  required>
                        @error('email')
                        <div class="invalid-feeedback">
                          {{ $message }}
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <input type="text" class="form-control" value="{{$user->username}}"  name="username2" hidden id="username2" required>
                      @error('username')
                        <div class="invalid-feeedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="col-sm-4">
                      ...
                      <input type="text" value="{{$user->no_hp}}" name="no_hp2" class="form-control" hidden id="no_hp2" required>
                        @error('no_hp')
                        <div class="invalid-feeedback">
                          {{ $message }}
                        </div>
