...
@section('title','Data Profile Pengguna')   
@section('content')          
...
<div class="col-md-6 container">
            <div class="card card-dark card-outline">
              <!-- card-body -->
              <h1 align="center" style="color:#212529"><b>Data Profile Pengguna</b></h1>
          ...
          <!-- contents of profile -->
                ...
                <a href="{{route('datapengguna')}}" class="btn btn-dark btn-block"><b>Kembali</b></a>
              <!-- end profile -->
              </div>
              <!-- /.card-body -->
            </div>
