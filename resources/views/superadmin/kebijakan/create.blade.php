        ...
        <div class="col-md-12">
          <div class="card card-outline card-info">
            <div class="card-header">
              <h3 class="card-title">
              <i class="fas fa-exclamation"></i> <b>Tambah Kebijakan</b>
              </h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body pad">
              <div class="mb-3">
                <form class="form-horizontal" action="{{route('store_kebijakan')}}" method="POST" enctype="multipart/form-data" id="submitform">
                 @csrf
