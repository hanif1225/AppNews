...
@section('content')   
    ...
    <div class="col-md-10 container">
        <div class="card card-dark">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{route('postingan_store')}}" method="POST" enctype="multipart/form-data">
              @csrf
                <div class="card-body">
                  <!-- row1 -->
                  ...
                  <div class="form-group">
                    <label for="gambar" class="ml-2 col-form-label">Gambar Utama</label>
                    <div class="col-sm-4">
                ...
                <div class="card-footer">
                  ...
                  <a href="{{route('postingan')}}" class="btn btn-info float-right">Cancel</a>
                </div>
                <!-- /.card-footer -->
              </form>
        </div>
