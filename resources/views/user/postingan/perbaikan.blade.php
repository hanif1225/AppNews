...
@section('content')   
    ...
    <div class="col-md-10 container">
        <div class="card card-dark">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{route('postingan_update',$postingan->slug)}}" method="POST" enctype="multipart/form-data">
              @method('put')
              @csrf
                <div class="card-body">
                  <!-- row1 -->
                ...
                <div class="card-footer">
                  ...
                  <a href="{{route('postingan_reject')}}" class="btn btn-info float-right">Cancel</a>
                </div>
                <!-- /.card-footer -->
              </form>
        </div>
