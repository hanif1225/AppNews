          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title"><i class="fas fa-clipboard"></i> <b>Berita Ditolak</b></h3>

                <div class="card-tools">
                 <form action="/postingan/reject" >
                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  @foreach($data_postingan as $postingan)
                    <tr>
                      ...
                      <td>
                        <!-- <a href="{{route('postingan_show',$postingan->slug)}}" class="btn btn-sm btn-success"><i class="fas fa-search"></i></a> -->
                        <a href="{{route('postingan_perbaikan',$postingan->slug)}}" class="btn btn-sm btn-primary"><i class="fas fa-tools"></i></a>
                        <form action="{{route('postingan_delete',$postingan->slug)}}" method="post" class="d-inline">
                          @method('delete')
                          @csrf
