...
<div class="col-md-6 container">
          ...
          @if($user->profil == null)
              <ul class="list-group list-group-unbordered mb-3 mt-2">
                ...
                <a href="{{route('create_profile')}}" class="btn btn-primary btn-block"><b>Lengkapi Profile</b></a>
              @else
                ...
                <a href="{{route('profile.edit',$user->profil->id)}}" class="btn btn-dark btn-block"><b>Edit Profile</b></a>
                <a href="{{route('pendaftaran',$user->id)}}" class="btn btn-dark btn-block"><b>Daftar Kontributor/Editor</b></a>
              @endif
              <!-- end profile -->
              </div>
              <!-- /.card-body -->
