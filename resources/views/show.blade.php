                ...
                <div class=" col-lg-9">
                    <div class="binduz-er-author-item mb-40">
                        ...
                        <div class="binduz-er-blog-details-box">
                            ...
                            <br>
                            @if(auth()->user() == null)
                            <a href="/register" class="text-danger"><i class="fas fa-heart"></i> {{$like}} Like</a>
                            @elseif(auth()->user()->level == "user")
                            <a href="/like_user/{{$postingan->id}}" class="text-danger"><i class="fas fa-heart"></i> {{$like}} Like</a>
                            ...
                            <a href="/like/{{$postingan->id}}" class="text-danger"><i class="fas fa-heart"></i> {{$like}} Like</a>
                            @elseif(auth()->user()->level == "editor")
                            <a href="#" class="text-danger"><i class="fas fa-heart"></i> {{$like}} Like</a>
                            @endif
                                ...
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-lg-12">
                                            ...
                                            @if(auth()->user() == null)
                                                <a href="/register" class="binduz-er-main-btn">Kirim Komentar</a>
                                            @elseif(auth()->user()->level == "user")
                            ...
                            @foreach($komentar as $komen)
                                <div class="binduz-er-author">
                                @if($komen->user->profil == null)
                                <img src="{{asset('foto')}}/user.png" class="rounded-circle" height="40" width="40" alt="">
                                @else
                                <img src="{{asset('foto')}}/{{ $komen->user->profil->foto}}" class="rounded-circle" height="40" width="40" alt="">
                                @endif

                                    <span class="px-1"><b>{{$komen->user->name}}</b></span>
                                      <div class="px-5"> 
                                        <p>{{$komen->isi }}</p>
                                      </div>
                                </div>
