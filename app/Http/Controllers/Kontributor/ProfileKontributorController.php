...
class ProfileKontributorController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        if(auth()->user()->level == 'kontributor'){
            return view('kontributor.profile.index', [
    ...
    {
        return view('kontributor.profile.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/kontributor/profile')->with('pesan', 'Data Profile Berhasil Di Simpan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('kontributor.profile.edit',compact('profil','user'));    
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/kontributor/profile')->with('pesan', 'Berhasil edit data');
