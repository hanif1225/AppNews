...
class AfiliasirestController extends Controller
{
    ...
    public function update(Request $request,$id)
    {
        ...
        if($data->kode_afiliasi != $request->kode_undangan)
        {
            if($data_pengundang)
            {
                ...
                else
                {
                    ...
                    return response()->json([
                        'success' => true,
                        'message' => "Kode Undangan Berhasil Dimasukkan",
                    ]);
            }
            else
            {
                return response()->json([
                    'success' => true,
                    'message' => "Kode Undangan Tidak Sesuai",
                ],500);
        ...
        else
        {
            return response()->json([
                'success' => true,
                'message' => "Kode udangan tidak boleh sama dengan kode afiliasi pribadi",
            ],500);
        }
    }
}
