...
class ProfileEditorController extends Controller
{
    ...
    public function index()
    {
        ...
        if(auth()->user()->level == 'editor'){
            return view('editor.profile.index', [
    ...
    {
        return view('editor.profile.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/editor/profile')->with('pesan', 'Data Profile Berhasil Di Simpan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('editor.profile.edit',compact('profil','user'));    
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/editor/profile')->with('pesan', 'Berhasil edit data');
    }
