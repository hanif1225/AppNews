...
class KomentarController extends Controller
{
    public function index()
    {
        ...
        $no = 0;
        return view('superadmin.komentar.index', [
    ...
    {
        $no = 0;
        return view('superadmin.komentar.pending', [
            "komentar" => Komentar::with(['postingan','user'])
    ...
    {
        $no = 0;
        return view('superadmin.komentar.ditolak', [
            "komentar" => Komentar::with(['postingan','user'])
    ...
    public function update(Request $request, $id)
    {
            ...
            return redirect('/admkomentar')->with('pesan', 'Komentar Berhasil di Aktifkan');
    }
    ...
    public function rejected(Request $request, $id)
    {
        ...
        return redirect('/admkomentar/ditolak')->with('pesan', 'Data Komentar Berhasil Ditolak');
        
    }
    public function alasan($id)
    {
        return view('superadmin.komentar.alasan',[
    ...
    public function destroy($id)
    {
        ...
        return redirect('/admkomentar/ditolak')->with('pesan', 'Data berhasil di hapus');
    }
    ...
    public function show($id)
    {
        ...
        return view('superadmin.komentar.show',[
